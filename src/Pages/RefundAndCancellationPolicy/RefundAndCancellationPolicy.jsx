                    ...
                    <div className="text-[#000000]">
                              ...
                              <div className="container mx-auto px-5 pt-20 pb-10">
                                        <div>
                                                  ...
                                                  <p className="mb-6">
                                                            Welcome to iLera . These Refund and Cancellation Policy ("Refund and Cancellation Policy") govern your use of our services provided through the App. By accessing or using the App, you agree to comply with and be bound by these Terms. If you do not agree with these Terms, you should not use the App.
                                                            Services
