                    ...
                    <div className="container mx-auto p-5 space-y-8">
                              ...
                              <div className="flex flex-col md:flex-row gap-5">
                                        ...
                                        <div className="space-y-6 mt-5">
                                                  <div className="space-y-3">
                                                            ...
                                                            <h1 className="text-3xl font-bold text-[#0091FF]">Trendy Urban Cafe in Dhaka City</h1>
                                                  </div>
                                                  ...
                                                  <div className="flex gap-3">
                                                            <button className="bg-[#0091FF] hover:bg-[#0091FF] text-white px-5 py-2 rounded">Interested</button>
                              ...
                              <div className="space-y-4">
                                        <p className="text-gray-700 leading-relaxed">
                                                  Located in the heart of Banani, this cozy, fully-operational urban cafe is a favorite among young
                                                  professionals, students, and tourists. The business boasts a strong brand identity, stylish interior, and a
                                                  loyal customer base.
                                        </p>
                                        <p className="text-gray-700 leading-relaxed">
                                                  The cafe is known for its handcrafted coffee, fresh bakery items, and comfortable ambiance perfect for casual
                              ...
                              <div className="grid lg:grid-cols-2 gap-8">
                                        ...
                                        <div>
                                                  <div className="flex items-center gap-2 text-[#0091FF]">
                                                            ...
                                                            <span className="font-semibold text-[#000000]">15th February 2025 | 10:00 AM – 4:00 PM</span>
                                                  </div>
                                                  <div className="space-y-4">
                                                            <div>
                                                                      <h3 className="text-lg font-semibold text-blue-600 mb-3">Hosted by</h3>
                                                                      <div className="flex items-start gap-3">
                                                                                ...
                                                                                <div className="space-y-1">
                                                                                          ...
                                                                                          <hr />
                                                                                          <button className="w-full bg-[#0091FF] text-white px-5 py-2 font-bold rounded">Send Message</button>
                                                                                </div>
                                                                      </div>
                                                            </div>
                                                  </div>
                                                  ...
                                                  <div className="space-y-4">
                                                            <div className="flex items-start gap-2">
                                                                      ...
                                                                      <span className="text-sm text-[#000000]">
                                                                                Conference Hall 3, TechSphere Tower, 789 Silicon Avenue, San Francisco
                                                                      </span>
                                                            </div>
