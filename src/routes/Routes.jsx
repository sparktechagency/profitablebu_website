...
export const router = createBrowserRouter([
  ...
  element: <CountryLandingPage />,
      ...
      {
        path: "/plane",
        element: <ProtectedRoute><SubscriptionPlane></SubscriptionPlane></ProtectedRoute>,
      },
      {
      ...
      {
        path: "/faqs",
        element: <ProtectedRoute><Faqs></Faqs></ProtectedRoute>,
      },
      {
        path: "/faqsSeller",
      ...
      },
      {
        ...
        element: <ProtectedRoute><MyBusiness></MyBusiness></ProtectedRoute>,
      },
      {
      ...
      {
        path: "/addnewbusiness",
        element: <ProtectedRoute><AddNewBusiness></AddNewBusiness></ProtectedRoute>,
      },
      {
      ...
      },
      {
        ...
        element: <ProtectedRoute><BuyerContactInfo /></ProtectedRoute>,
      },
      {
